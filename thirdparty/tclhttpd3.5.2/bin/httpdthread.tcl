...
#
# RCS: @(#) $Id: httpdthread.tcl,v 1.19 2004/04/23 02:11:22 coldstore Exp $
...
foreach path [concat \
    [list [file join $Config(lib) mime.types]] \
...
#APN package require httpd::dirlist		;# Directory listings
#APN package require httpd::include		;# Server side includes
...
#APN package require httpd::direct		;# Application Direct URLs

#APN package require httpd::status		;# Built in status counters
#APN Status_Url			/status /images

#APN package require httpd::mail		;# Crude email form handlers
#APN Mail_Url			/mail

#APN package require httpd::admin		;# Url-based administration
#APN Admin_Url			/admin
...
#APN package require httpd::redirect	;# Url redirection tables
#APN Redirect_Init			/redirect

#APN package require httpd::doctools ;# doctool type conversions
